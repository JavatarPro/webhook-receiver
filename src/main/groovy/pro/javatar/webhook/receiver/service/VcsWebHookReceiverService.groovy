...
@Service
@Slf4j("logger")
class VcsWebHookReceiverService {

    protected WebHookConfig webHookConfig

    VcsWebHookReceiverService(WebHookConfig webHookConfig) {
        this.webHookConfig = webHookConfig
    }

    boolean shouldTriggerJenkinsWebHook(VcsPushRequestBO pushRequest) {
    ...
    JenkinsRemoteJobRequest getJenkinsRemoteJobRequest(VcsPushRequestBO pushRequest) {
